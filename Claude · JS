// Vercel serverless function — relays requests to the Anthropic API.
// Uses CommonJS (module.exports) for maximum compatibility without package.json.
...
module.exports = async function handler(req, res) {
  ...
  try {
    // Parse body (Vercel usually parses JSON automatically, but handle both cases)
    let body = req.body;
