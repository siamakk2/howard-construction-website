...
(function () {
  ...
  var CONFIG = {
    ...
    theme: {
      bg: '#FDFEFF', panelBg: '#F0F7FF', card: '#F0F7FF', track: '#BBDEFB',
      line: '#BBDEFB', lineHi: '#90CAF9',
      text: '#0A1628', muted: '#33404F', dim: '#4A5568',
      accent: '#1565C0', accentHi: '#0D4A94', accentInk: '#FFFFFF',
      accentFade: 'rgba(21,101,192,.35)', accentWash: 'rgba(21,101,192,.14)',
